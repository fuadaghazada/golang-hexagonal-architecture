...
func Start() {
	...
	ah := AccountHandler{service: service.NewAccountService(accountRepositoryDb, transactionRepositoryDb)}
	...
	router.HandleFunc("/accounts/{accountId:[0-9]+}/transaction", ah.NewTransaction).Methods(http.MethodPost)
